...
import com.example.wonhoi_unsplash_copyright_free_photos.databinding.ItemPhotoBinding

class PhotoAdapter : RecyclerView.Adapter<PhotoAdapter.ViewHolder>() {
    // get Photo at Repository.getRandomPhotos
    ...
    inner class ViewHolder( private val binding : ItemPhotoBinding ) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind (photo : PhotoResponse) {
            // get pictures size and make Pictures frame Space
